    ...
    <el-card class="box">
      ...
      <el-form ref="myForm" :model="loginFrom" :rules="loginReturn">
        ...
        <el-form-item prop="check">
          <el-checkbox v-model="loginFrom.check">我已阅读并同意无条件被坑</el-checkbox>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" class="btn" @click="submitLogin('myForm')">登录</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
...
export default {
  data () {
    return {
      ...
      loginReturn: {
        phone: [
          { reqired: true, message: '请输入你的手机号' },
          { pattern: /^1[3456789]\d{9}$/, message: '手机号格式不正确' }
        ],
        code: [
          { reqired: true, message: '请输入你的验证码' },
